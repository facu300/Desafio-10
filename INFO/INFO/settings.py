...
SECRET_KEY = 'django-insecure-!d4x^b#t!qdutqbnv#t4ib0s%6uu2$=m9ec$+8i1q!q33)9q-t'
...
INSTALLED_APPS = [
    ...
    'blog.apps.BlogConfig', #agregado para que tenga en cuenta a la app sitio principal
]
